...
echo 120.54 22.92 | gmt psxy -R -J -Sa0.7 -W0.01 -G255/0/0 -O -K >> $out_ps
echo "120.54 22.82 M:6.6 Depth:14.6km" | gmt pstext -R -J -O -K -F+f,Helvetica-Bold,black >> $out_ps
...
echo 120.54 6.6| gmt psxy -R -J -Sa0.7 -W0.01 -G255/0/0 -O -K >> $out_ps
...
echo 6.6 22.92 | gmt psxy -R -J -Sa0.7 -W0.01 -G255/0/0 -O -K >> $out_ps
